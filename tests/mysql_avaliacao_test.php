<?php
    ...
    buscar_teste();
    insert_teste2(1, 'teste testado', 'pfvvv funciona', '2023-08-15');
    buscar_teste2();
    insert_teste3(1, 'tem q funcionar', 1, 1);
    buscar_teste3();

    //atualiza dados
    update_teste(1, 'Muliro', 'muliro@gmail.com');
    buscar_teste();
    update_teste2(1, 'Professor', 'me da 10000');
    buscar_teste2();
    update_teste3(1, 10, 'não aguento +');
    buscar_teste3();
